...
#define GAMECON_REPORT_DESC_LIGHTS(...)                                        \
  HID_USAGE_PAGE(HID_USAGE_PAGE_DESKTOP), HID_USAGE(0x00),                     \
      HID_COLLECTION(HID_COLLECTION_APPLICATION),                              \
      __VA_ARGS__ HID_REPORT_COUNT(13), /*7 button lights + 2 RGB Sets*/      \
      ...
      HID_STRING_MAXIMUM(16), HID_USAGE_MIN(1),                                \
      HID_USAGE_MAX(13), HID_OUTPUT(HID_DATA | HID_VARIABLE | HID_ABSOLUTE),   \
